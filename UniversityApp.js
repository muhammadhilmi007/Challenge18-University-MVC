const sqlite3 = require("sqlite3").verbose(); // masukkan ke File Database.js
const readline = require("readline"); // masukkan ke File App.js
const Table = require("cli-table3");

// Buat Koneksi Database
const db = new sqlite3.Database("university.db"); // masukkan ke File Database.js

// Buat Table users jika belum ada // masukkan ke File Database.js
...
// Buat Table kontrak jika belum ada // masukkan ke File Database.js
...
const rl = readline.createInterface({ // masukkan ke File App.js
  input: process.stdin,
  output: process.stdout,
});

// Class utama untuk sistem universitas
class UniversityApp { // masukkan ke File App.js
  constructor() {
    this.currentUser = null;
  }

  // Method untuk memulai Program
  start() { // masukkan ke File App.js
    console.log("=========================================="); // masukkan ke File AuthView.js
    console.log(
  ...
  // Method Untuk Login
  login() { // masukkan ke File App.js
    rl.question("Username: ", (username) => { // masukkan ke File AuthView.js
      // Cek Username di database
      db.get( // masukkan ke File User.js
        "SELECT * FROM users WHERE username = ?",
        [username], 
        (err, user) => { // masukkan ke File AuthController.js
          if (err) {
            console.log(err);
            return;
          }

          if (!user) { // masukkan ke File AuthController.js
            console.log("Username tidak terdaftar");
            this.login();
            return;
          }

          rl.question("Password: ", (password) => { // masukkan ke File AuthView.js
            if (password === user.password) { // masukkan ke File AuthController.js
              this.currentUser = user;
              console.log( // masukkan ke File AuthView.js
                `Welcome, ${user.username}. Your Access Level is : ${user.role}`
              );
              this.showMainMenu();
            } else { // masukkan ke File AuthView.js
  ...
  showMainMenu() {  // masukkan ke File MainView.js
    console.log("====================================");
    ...
    rl.question("Masukkan salah satu nomor dari opsi diatas: ", (choice) => { // masukkan ke File App.js
      switch (choice) {
        case "1":
...
class MahasiswaMenu {
  show() {
    console.log("======================================"); // masukkan ke File MahasiswaView.js
    console.log("Silahkan pilih opsi dibawah ini: ");
